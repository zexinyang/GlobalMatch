...
const double singleMove[14] = {0.4, 0.64, 0.784, 0.8704, 0.92224, 0.95334, 0.97201, 0.9832, 0.98992, 0.99395, 0.99637,
                               0.99782, 0.99869, 0.99922};
...
public:
     ...
     * by Cloth.time_step_() many times per frame*/
